...
public class ApplicationDbContext : DbContext, IApplicationDbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Credential>().HasData(
            new Credential { Id = new Guid("b9e216ac-f9ff-4abc-a789-a1c36f006948"), Password = "123456", StudentId = new Guid("edfc80e0-1c2d-4112-8b47-56371dade5ab")},
            new Credential { Id = new Guid("f685d368-f149-452d-8934-0d216424223e"), Password = "123456", StudentId = new Guid("a6660f6e-96bb-4d2d-9a45-f28edc0b254d")}
        );
